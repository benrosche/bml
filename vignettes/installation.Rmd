...
Installing `bml` pulls in its R dependencies automatically, including the
Bayesian workflow packages it builds on (**posterior** for draws handling,
**loo** for cross-validation). For graphical posterior predictive checks with
`pp_check()`, additionally install **bayesplot**:
