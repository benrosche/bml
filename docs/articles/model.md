...
\\\[0,1\]\\, e.g., via priors = list(“b1~dunif(0,1)”).
...
In `bml`, specify `family = "Cox"`. The optional `cox_intervals`
argument controls the number of intervals for the piecewise constant
baseline hazard:
